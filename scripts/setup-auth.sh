...
for k in NEXT_PUBLIC_SUPABASE_URL NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY APP_PUBLIC_URL NETWORK_ONLY; do
  case $k in
...
echo "Supabase redirect (required): https://pr.finalrev.com/auth/callback"
