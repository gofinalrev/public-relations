...
[[ -z "$AUTH_SECRET" ]] && { echo "Need AUTH_SECRET"; exit 1; }
[[ -z "$GOOGLE_ID" || -z "$GOOGLE_SECRET" ]] && { echo "Need GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET"; exit 1; }
...
echo ""
echo "Google OAuth authorized redirect URI (CTO should have this):"
